...
function classDeclaration(n, indent){
	var id = n.id,
		parent = n.parent;
		
	var name = (id === null) ? "" : expr(id, '####', 18, false);
	var parentName = (parent === null) ? "" : expr(parent, '####', 18, false);
	...
	var init = "";
	if(parentName){
		init = " extends "+parentName+" ";
	}
	
	return "class "+ name + init + body;
